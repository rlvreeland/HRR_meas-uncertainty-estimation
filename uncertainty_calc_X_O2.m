...
% This function is used to calculate partial derivatives for the input 
% parameters for O2, when voltages are not available given the measurement
% concentration and the calibration gases. This function also
...
% have to use the x_CO2_calc so that the uncertainty in CO2 concentration
% is accounted for
