classdef Fire_model
    properties
        ...
        % Bidirectional probe parameters
        f_Re = 1.07;

        % Calorimetry parameters
        alpha = 1.105; % directly between pure C and H2
        ...
        flow_fraction {mustBeNumeric} %The fraction of the mass entrained 
                                      % to the flow rate of the hood
        ...
        % Place holder for characteristic fire values
        D_fire_m
        flame_height_m
    ...
    methods
        ...
        function obj = Pool_fire_diameter(obj, HRR, m_dot_inf_kg_per_m2,...
            ...
            for i = 1:length(HRR)
                ...
                % Remove diameters that are outside of model (<= 0.2)
                if Diameter_m > 0.2
        ...
        % After determining the diameter use this function to obtain the
        ...
        function obj = model_HRR_measurements(obj, HRR)
            ...
            % Check is Diameter of fire is an array with length HRR, if 
            ...
            % Calculate the flame heights using Hezkestad virtual origin
            obj.flame_height_m = 0.235*HRR.^(2/5)-1.02*obj.D_fire_m;

            % Use Plume correlations to calculate entrainment of the plume
            ...
            % Calculate mass flow of fuel supplied
            ...
            % HRR
            for i = 1:length_HRR
                % pull out specific test we are looking out for simplicity
                Q_HRR = HRR(i);
                ...
                if isnan(m_dot_e_kg_per_s)
                    ...
                    % find solution with x_O2 closest to ambient, this
                    % removes extraneous solutions
            ...
            % Get the density of the gas in the duct
